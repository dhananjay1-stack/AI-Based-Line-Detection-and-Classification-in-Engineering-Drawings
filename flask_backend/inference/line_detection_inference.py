...
class LineDetectionInference:
    ...
    def __init__(
        ...
        self.class_colors = class_colors or {
            ...
            "phantom_line": [0, 255, 255],
            "section_hatching": [255, 165, 0],
            "break_line": [128, 0, 128],
            "cutting_plane": [0, 128, 128],
            "hidden_line": [255, 182, 193]
        }
    ...
    def process_image(
        ...
        print(f"\n  Detected classes in output: {unique_classes.tolist()}")
        ...
        # 2. Binary masks per class (skip background)
    ...
    def _print_probability_stats(self, prob_class: np.ndarray):
        """Print detailed probability statistics (from inference_step3.py)."""
